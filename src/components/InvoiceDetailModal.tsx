...
export const InvoiceDetailModal: React.FC<InvoiceDetailModalProps> = ({ isOpen, onClose, invoice, profile }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      >
        {/* Header */}
        <div className="p-6 border-b border-white/5 flex items-center justify-between bg-[#0C1020] sticky top-0 z-10">
          <div className="flex items-center gap-4">
            <h2 className="text-xl font-bold">{invoice.invoiceNumber} Preview</h2>
          ...
          <div className="flex items-center gap-2">
            <button onClick={handlePrint} className="p-2 hover:bg-white/5 rounded-lg transition-colors text-gray-400 hover:text-white">
        ...
        {/* Invoice Paper */}
        <div className="flex-1 overflow-y-auto p-8 bg-[#060810]/50">
          <div id="invoice-paper" className="bg-white text-black p-12 rounded-sm shadow-2xl max-w-[800px] mx-auto min-h-[1123px] flex flex-col print:shadow-none print:p-0 print:m-0 print:w-full">
            <style>{`
